...
<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Ventas</title>
  ...
  <table class="table">
    ...
    <?php foreach($ventas as $v): ?>
      <tr>
        ...
        <td><a href="resumen.php?id=<?= $v['id'] ?>" class="btn btn-ghost" style="padding:5px 12px;font-size:.8rem">Ver</a></td>
      </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
